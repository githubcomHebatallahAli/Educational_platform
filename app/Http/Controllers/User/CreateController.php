...
//     // جلب وقت البدء من قاعدة البيانات أو تعيينه لأول مرة
//     $studentExam = StudentExam::firstOrNew(
//         ['user_id' => $request->user_id, 'exam_id' => $request->exam_id],
//         ['started_at' => now()]
//     );

//     // تحويل وقت البدء إلى كائن Carbon إذا كان string
//     $startedAt = $studentExam->started_at instanceof \Carbon\Carbon
//         ? $studentExam->started_at
//         : \Carbon\Carbon::parse($studentExam->started_at);
...
//     // تحديث السجل أو إنشاءه إذا لم يكن موجودًا
//     $studentExam->fill([
//         'score' => $score,
//         'has_attempted' => true,
//         'submitted_at' => $submittedAt,
